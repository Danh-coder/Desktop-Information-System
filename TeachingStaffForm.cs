...
{
    public partial class TeachingStaffForm : UserControl
    {
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double salary;
                string[] subjects = { subject1Input.Text, subject2Input.Text };
                ...
                Teacher teacher = new Teacher(name, phone, email, salary, subjects);
                Controller.AddNewData(teacher);
